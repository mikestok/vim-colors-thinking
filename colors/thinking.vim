" Name:       thinking.vim
" Version:    0.0.0
" Maintainer: github.com/mikestok
" License:    The MIT License (MIT)
"
" A colorscheme for Vim that focuses on comments and
" documentation rather than details of the code.
"
...
if &background == "dark"
  ...
  let s:bg_very_subtle  = s:subtle_black
	let s:bg_standout     = s:dark_blue
	let s:standout        = s:white
  ...
  let s:bg_very_subtle  = s:lightest_gray
	let s:bg_standout     = s:light_yellow
	let s:standout        = s:black
...
call s:h("Normal",        {"bg": s:bg, "fg": s:norm_subtle})
...
call s:h("Comment",       {"fg": s:standout, "cterm": "italic", "gui": "italic"})

"call s:h("Constant",      {"fg": s:purple})
call s:h("Constant",      {"cterm": "italic", "gui": "italic"})
...
" call s:h("Special",       {"fg": s:norm, "cterm": "italic", "gui": "italic"})
...
call s:h("Todo",          {"bg": s:bg_standout, "fg": s:standout, "cterm": "italic", "gui": "italic"})
...
call s:h("LineNr",        {"bg": s:bg_very_subtle, "fg": s:bg_subtle})
